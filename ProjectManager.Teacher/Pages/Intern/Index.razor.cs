...
using ProjectManager.Teacher;
using ProjectManager.Teacher.Shared;
...
namespace ProjectManager.Teacher.Pages.Intern
{
        ...
        public class IndexBase : CommonComponentBase
        {
            ...
            public IEnumerable<Entity.Intern> ListInterns { get; set; }
